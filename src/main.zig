...
pub fn runDayAndPart(allocator: std.mem.Allocator, contents: []const u8, day: usize, part: usize) !i64 {
    ...
    switch (day) {
        ...
        6 => {
            solvePartOne = aoc2024.day06.solvePartOne;
            solvePartTwo = aoc2024.day06.solvePartTwo;
        },
        7 => {
            solvePartOne = aoc2024.day07.solvePartOne;
            solvePartTwo = aoc2024.day07.solvePartTwo;
        },
        8 => {
            solvePartOne = aoc2024.day08.solvePartOne;
            solvePartTwo = aoc2024.day08.solvePartTwo;
        },
